                    ...
                    return (
                        ...
                        >
                            <Link
                                ...
                                className="group relative flex flex-col flex-1 p-8 rounded-sm border border-white/10 bg-white/5 backdrop-blur-md transition-all duration-300 hover:bg-white/10 hover:border-cyan-400/50 cursor-none"
                            >
                                <div className="absolute inset-0 bg-gradient-to-br from-white/5 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500 pointer-events-none rounded-sm" />
                                ...
                                <div className="flex-1">
                                    ...
                                    <h3 className="font-noto text-base md:text-xl font-bold group-hover:text-cyan-400 transition-colors line-clamp-2 mb-3">
                                        {displayTitle}
                                    </h3>
